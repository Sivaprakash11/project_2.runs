...
HD_PWD='C:/Users/mvsiv/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_8to3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_8to3.tcl
